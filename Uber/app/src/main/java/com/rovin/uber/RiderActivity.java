...
public class RiderActivity extends FragmentActivity implements OnMapReadyCallback {
                                ...
                                if (Build.VERSION.SDK_INT < 23 || ContextCompat.checkSelfPermission(RiderActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                                    ...
                                    if (lastKnownLocation != null) {
                                        ...
                                        if (distanceInMiles < 0.01) {
                                            ...
                                            requestActive = false; //Stop 2s updating check
    ...
    public void callUber(View view) {
        ...
        Log.i("Info", "Call Uber: requestActive: " + Boolean.toString(requestActive));
    ...
    public void updateMap(Location location) {
        ...
        //Log.i("RiderActivity", "driverActive is: " + Boolean.toString(driverActive));
        //Log.i("RiderActivity", "requestActive is: " + Boolean.toString(requestActive));
