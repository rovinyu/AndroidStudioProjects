        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (checkedTextView.isChecked()) {
                    ...
                    List<String> aList = ParseUser.getCurrentUser().getList("isFollowing");

                    aList.add(users.get(i));
                    ...
                    ParseUser.getCurrentUser().saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            if (e == null) {
                                List<String> followingList = ParseUser.getCurrentUser().getList("isFollowing");
                                Log.i("Info", followingList.toString());
                                Toast.makeText(Main2Activity.this, "Add following successfully", Toast.LENGTH_SHORT).show();
                            }
                            else {
                    ...
                    ParseUser.getCurrentUser().saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            if (e == null) {
                                List<String> followingList = ParseUser.getCurrentUser().getList("isFollowing");
                                Log.i("Info", followingList.toString());
                                Toast.makeText(Main2Activity.this, "Delete following successfully", Toast.LENGTH_SHORT).show();
                            }
                            else {
                                Toast.makeText(Main2Activity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
